let taxiFareApiUrl = 'https://taxifare-659642642571.europe-west1.run.app/predict'; // replace with your API endpoint
const centralCoordinates = [-74.00597, 40.71427]; // starting position [lng, lat]
const taxiFareApiUrl = 'https://taxifare-659642642571.europe-west1.run.app/predict';
